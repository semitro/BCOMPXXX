...
public class DisplayStyles {
   ...
   public static final Font FONT_COURIER_PLAIN_12 = new Font("Courier New", 0, 12);
   public static final Font FONT_COURIER_BOLD_18 = new Font("Courier New", 1, 18);
   public static final int FONT_COURIER_BOLD_18_WIDTH = (int)Math.round(FONT_COURIER_BOLD_18.getStringBounds("0", fr).getWidth());
   public static final Font FONT_COURIER_BOLD_20 = new Font("Courier New", 1, 20);
   public static final Font FONT_COURIER_BOLD_21 = new Font("Courier New", 1, 21);
   public static final int FONT_COURIER_BOLD_21_WIDTH = (int)Math.round(FONT_COURIER_BOLD_21.getStringBounds("0", fr).getWidth());
   public static final Font FONT_COURIER_BOLD_23 = new Font("Courier New", 1, 23);
   public static final int FONT_COURIER_BOLD_23_WIDTH = (int)Math.round(FONT_COURIER_BOLD_23.getStringBounds("0", fr).getWidth());
   public static final Font FONT_COURIER_BOLD_25 = new Font("Courier New", 1, 25);
   public static final int FONT_COURIER_BOLD_25_WIDTH = (int)Math.round(FONT_COURIER_BOLD_25.getStringBounds("0", fr).getWidth());
   public static final Font FONT_COURIER_BOLD_45 = new Font("Courier New", 1, 45);
   ...
   public static final Dimension PANE_SIZE = new Dimension(856, 544);
   ...
   public static final int ACTIVE_BIT_X = 8 + REG_16_WIDTH + 16;
   public static final int BUS_LEFT_INPUT_X1 = 8 + REG_16_HALF;
   public static final int BUS_KEY_ALU = 440;
   public static final int REG_C_X_BV = BUS_LEFT_INPUT_X1 + 20 + 1;
   ...
   public static final int BUS_LEFT_INPUT_X = BUS_LEFT_INPUT_X1 + 60 + 1;
   public static final int BUS_LEFT_INPUT_DOWN = 231;
   public static final int BUS_LEFT_INPUT_UP = 224;
   public static final int BUS_FROM_ACCUM_X = REG_C_X_BV - 4 - 1;
   ...
   public static final int BUS_FROM_IP_X = REG_IP_X_BV - 4 - 1;
   public static final int BUS_FROM_IP_Y = 181;
   public static final int BUS_RIGHT_X1 = BUS_FROM_IP_X - 16;
   public static final int BUS_RIGHT_X = REG_C_X_BV + 181 - 45 + 2;
   ...
   public static final int BUS_RIGHT_TO_X = REG_ACCUM_X_BV + REG_16_WIDTH + 16 + 4;
   public static final int REG_ADDR_Y_BV = 17;
   public static final int BUS_TO_ADDR_Y = 43;
   public static final int BUS_TO_ADDR_X = REG_ACCUM_X_BV + REG_11_WIDTH + 13;
   public static final int REG_INSTR_X_BV = BUS_RIGHT_TO_X + 4 + 16 + 1;
   public static final int BUS_TO_INSTR_X = REG_INSTR_X_BV - 13 - 1;
   public static final int BUS_TO_DATA_X = REG_ACCUM_X_BV + REG_16_WIDTH + 13;
   public static final int BUS_FROM_INSTR_Y = 74;
   public static final int BUS_FROM_INSTR_X = REG_INSTR_X_BV + 32 + 4;
   ...
   public static final int BUS_ADDR_X1 = REG_ACCUM_X_BV - 4 - 1;
   public static final int BUS_ADDR_X2 = 1 + MEM_WIDTH + 13;
   public static final int BUS_READ_Y = 99;
   public static final int BUS_WRITE_Y = 125;
   public static final int BUS_READ_X1 = REG_ACCUM_X_BV - 13 - 1;
   public static final int BUS_READ_X2 = 1 + MEM_WIDTH + 4;
   ...
   private static final int REGS_RIGHT_X = 1 + MEM_WIDTH + REG_8_WIDTH + 16 - 1;
   ...
   public static final int BUS_TSF_X1 = IO_X - 16 - 4 - 1 + FLAG_OFFSET;
   public static final int BUS_TSF_Y2 = 80;
   public static final int BUS_TSF_Y = 96;
   public static final int BUS_TSF_Y1 = 82;
   public static final int BUS_TSF_X = CU_X_IO + REG_8_WIDTH - 16 - 1;
   ...
   public static final int BUS_IO_ADDR_X = CU_X_IO + REG_4_WIDTH + 4;
   ...
   public static final int BUS_IN_X = REG_ACC_X_IO + REG_4_WIDTH + 13;
   public static final int BUS_OUT_Y = 401;
   public static final int BUS_OUT_Y2 = 394;
   public static final int BUS_OUT_X = REG_ACC_X_IO + REG_4_WIDTH + 4;
   public static final int LABEL_OUT_Y = 409;
   private static final int MP_REGS_WIDTH = REG_4_WIDTH + 16 + REG_5_WIDTH;
   public static final int ALU_X_MP = CU_X_IO + (MP_REGS_WIDTH - 181) / 2;
