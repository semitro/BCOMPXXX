...
public class StateReg extends PseudoRegister {
   ...
   public static String[] FULLNAME = new String[]{"Перенос (C)", "Нуль (Z)", "Знак (N)", "0", "Разрешение прерывания", "Запрос прерывания", "Флаг ВУ", "Работа/останов", "Программа"};
   public static String[] NAME = new String[]{"C", "Z", "N", "0", "EI", "INT", "READY", "RUN", "PROG"};
